...
exports.sendContractEmail = exports.sendInvoiceEmail = void 0;
...
exports.sendInvoiceEmail = functions
    ...
    const toEmail = recipientEmail || ((_a = invoice.to) === null || _a === void 0 ? void 0 : _a.email);
    if (!toEmail) {
        throw new functions.https.HttpsError('failed-precondition', 'No recipient email address. Please add an email to the invoice.');
    }
...
function getContractTypeLabel(documentType) {
    switch (documentType) {
 ...
 */
exports.sendContractEmail = functions
    .runWith(runtimeOpts)
    .https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e;
    // Check authentication
    ...
    const toEmail = recipientEmail || ((_a = contract.formData) === null || _a === void 0 ? void 0 : _a.email);
    if (!toEmail) {
        throw new functions.https.HttpsError('failed-precondition', 'No recipient email address. Please add an email to the contract.');
    }
    ...
    const jobNumber = (job === null || job === void 0 ? void 0 : job.jobNumber) || 'N/A';
    const documentTypeLabel = getContractTypeLabel(contract.documentType);
    const customerName = ((_b = contract.formData) === null || _b === void 0 ? void 0 : _b.buyerName) || 'Customer';
    const signedDate = ((_d = (_c = contract.createdAt) === null || _c === void 0 ? void 0 : _c.toDate()) === null || _d === void 0 ? void 0 : _d.toLocaleDateString('en-US', {
        year: 'numeric',
        month: 'long',
        day: 'numeric',
    })) || 'Unknown date';
        ...
        <div style="background: #f9f9f9; padding: 30px; border: 1px solid #ddd; border-top: none;">
          ...
          <div style="background: white; border-radius: 8px; padding: 20px; margin-bottom: 20px; border: 1px solid #eee;">
            ...
            <table style="width: 100%; font-size: 14px;">
              ...
              ${((_e = contract.formData) === null || _e === void 0 ? void 0 : _e.purchasePrice) ? `
              <tr>
