...
function getEntityFullName(entity) {
    switch (entity) {
...
function filterByDateRange(invoices, startDate, endDate) {
...
async function formatPnLSheets(sheets, spreadsheetId) {
    var _a, _b;
    const spreadsheet = await sheets.spreadsheets.get({ spreadsheetId });
    for (const sheet of spreadsheet.data.sheets || []) {
        const sheetId = (_a = sheet.properties) === null || _a === void 0 ? void 0 : _a.sheetId;
        const sheetTitle = (_b = sheet.properties) === null || _b === void 0 ? void 0 : _b.title;
        if (sheetId == null)
            continue;
        const requests = [
...
//# sourceMappingURL=pnlSync.js.map